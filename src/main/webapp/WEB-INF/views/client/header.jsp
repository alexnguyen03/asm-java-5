		...
		<div class="row">
			<div class="col-lg-3 col-md-3">
				<div class="header__logo">
					<a href="/"><img
						src="${pageContext.request.contextPath }/img/main-logo.png" alt=""
						height="33px" /></a>
				</div>
			</div>
			<div class="col-lg-5 col-md-5">
				<nav class="header__menu mobile-menu">
					<ul>
						<li class="${pageActive=='index'?'active':''}"><a href="/">Trang
								chủ</a></li>
						<li class="${pageActive=='shop'?'active':''}"><a href="/shop">Sản
								phẩm</a></li>
						<li class="${pageActive=='order-history'?'active':''}"><a
							href="/shop/order-history">Đơn hàng</a></li>
					</ul>
				</nav>
			</div>
			<div class="col-lg-4 col-md-4">
				<div class="header__nav__option">
					<a href="#" class="search-switch"><img
						src="img/icon/search.png" alt="" /></a> <a href="/shop/cart-detail"
						title="Giỏ hàng" class="position-relative pr-3"><img
						src="${pageContext.request.contextPath }/img/icon/cart.png" alt=""
						width="20px" /> <span
						class="badge badge-danger position-absolute " style="top: -2px;">2</span></a>

					<c:choose>
						<c:when test="${not empty sessionScope.username}">
							<div class="dropdown d-inline">
								<div class="btn btn-white dropdown-toggle  btn-sm" type="button"
									data-toggle="dropdown" aria-expanded="false">
									${sessionScope.username} <i class="fa fa-user-circle-o"
										aria-hidden="true"></i>
								</div>
						...
						<c:otherwise>
							<a href="/account/login"
								class="btn btn-outline-dark font-weight-bold"> ĐĂNG NHẬP</a>
						</c:otherwise>
					</c:choose>
				</div>
			</div>
