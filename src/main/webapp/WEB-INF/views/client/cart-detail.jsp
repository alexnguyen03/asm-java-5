      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
              ...
              <form action="">
                <table>
                  ...
                  <tbody>
                    <tr>
                      <td
                        class="product__cart__item d-flex justify-content-space-bewteen"
                      >
                        <div
                          class="form-check d-flex flex-column justify-content-center"
                        >
                          <input
                        ...
                        <div class="product__cart__item__pic">
                          <img
                            src="${pageContext.request.contextPath}/img/shopping-cart/HiFiMan HE-R9.jpg"
                            alt=""
                            width="90px"
                            height="90px"
                            class=""
            ...
            <div class="row">
              <div
                class="col-lg-3 col-md-3 col-sm-2 d-flex flex-column justify-content-center"
              >
                <div class="form-check d-flex">
                  ...
                  />
                  <label for="checkAll" class="font-weight-bold"
                    >Chọn tất cả</label
                  >
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="cart__total rounded">
              ...
              <ul>
                <li>
                  Tạm tính <span>400.000 <sup>đ</sup></span>
                </li>
                <li>
                  Tổng cộng <span>400.000 <sup>đ</sup></span>
                </li>
              </ul>
              <a href="/shop/checkout" class="btn btn-success w-100"
                >THANH TOÁN</a
              >
            </div>
          </div>
