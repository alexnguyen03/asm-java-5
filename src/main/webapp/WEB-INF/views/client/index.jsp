			...
			<div class="row product__filter">
				...
				<div
					...
					<div class="product__item">
						...
						<div class="product__item__text">
							...
							<h5>
								3.510.000 <span class="text-danger">đ</span>
							</h5>
						</div>
					</div>
				</div>
				...
				<div
					...
					<div class="product__item sale">
						<div class="product__item__pic">
							<img src="img/product/product-3.png" class="img-fluid" /> <span
								class="label">Mới</span>
						</div>
						<div class="product__item__text">
				...
				<div
					...
					<div class="product__item">
						...
						<div class="product__item__text">
							...
							<h5>
								225.000 <span class="text-danger">đ</span>
							</h5>
						</div>
					</div>
				</div>
				...
				<div
					...
					<div class="product__item">
						...
						<div class="product__item__text">
							...
							<h5>
								150.000 <span class="text-danger">đ</span>
							</h5>
						</div>
					</div>
				</div>
