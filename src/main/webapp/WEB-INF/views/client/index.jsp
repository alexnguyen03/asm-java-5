								...
								<div class="col-xl-5 col-lg-7 col-md-8">
									<div class="hero__social">
										...
										<p class="font-italic">Tai nghe không dây chính hãng bán
											...
											đại</p>
										<a href="/shop" class="btn btn-outline-dark">Mua
				...
				<div class="col-lg-12">
					<ul class="filter__controls">
						<li class="active" data-filter="*"><a href="/"
							class="text-dark" data-filter="*">Bán chạy nhất</a></li>
						<li data-filter=".new-arrivals"><a href="/top-lastest"
							class="text-dark" data-filter=".hot-sales">Vừa
								nhập hàng</a></li>
					</ul>
				</div>
			</div>
					...
					<div
						...
						<div class="product__item">
							<a href="/shop/shop-detail?id=${item.id}"
								...
								class="img-fluid" alt="${item.name}" /> <span
