...
<style>
body {
	background: url(img/login/6764552_3433839.jpg) center/cover no-repeat
		fixed;
	width: 100wh;
	height: 100vh;
	overflow: hidden;
				...
				<form action="#" class="mt-5">
					<div class="form-group">
						<input type="text" class="form-control" name="username"
							...
							placeholder="Tên đăng nhập..." /> <small
							id="helpId" class="form-text text-muted"></small>
					</div>
					<div class="form-group">
						<input type="password" class="form-control" name="username"
							id="username" aria-describedby="helpId" placeholder="Mật khẩu" />
						<small id="helpId" class="form-text text-muted"></small>
					</div>
					<p class="text-left">
						Không thể đăng nhập? <a href="/change-password"
							class="font-weight-bold" style="color: #0c2b4b">Lấy
							lại mật khẩu</a>
					</p>
					<button
