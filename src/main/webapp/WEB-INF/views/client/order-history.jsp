			...
			<div class="offcanvas__nav__option">
				<a href="#"
				   class="search-switch"><img src="${pageContext.request.contextPath}/img/icon/search.png"
						 alt="" /></a>
				<a href="#"><img src="${pageContext.request.contextPath}/img/icon/heart.png"
						 alt="" /></a>
				...
				<div class="row">
					<div class="col-lg-12 m-auto mt-4">
						...
						<div class="d-flex mt-3 mb-3">
							<form action="/shop/order-history/search"
								  method="post"
							...
							<div class="mr-auto pl-2">
								<a href="/shop/order-history"
								   ...
								   role="button"
								   aria-pressed="true"
								   style="height: 42px;">Làm
									mới</a>
							</div>
							<div class="pr-2 d-flex justify-content-center ">
								<form action="/shop/order-history/filter"
									  method="post"
									  class="d-flex justify-content-center">
									<div class="input-group"
										 style="width: 250px;">
										...
										<tr>
											...
											<td class="pt-4">
												<fmt:formatNumber type="number"
																  maxFractionDigits="3"
																  value="${ order.totalPrice}" /><sup>đ</sup>
											</td>
											<td class="pt-4">
												<fmt:formatNumber type="number"
																  maxFractionDigits="3"
								...
								<thead class="bg-dark text-white text-center">
									<tr>
										...
										<th scope="col"
											class="p-0">Ảnh</th>
										<th scope="col"
											class="p-0">Tên Sản Phẩm</th>
										<th scope="col"
											class="p-0">Đơn Giá</th>
										<th scope="col"
											class="p-0">Số Lượng</th>
										<th scope="col"
											class="p-0">Tổng Tiền</th>
									</tr>
								</thead>
								<tbody style="font-size: 15px;"
									...
									<c:forEach var="orderdetail"
										...
										<tr class="align-middle">
											...
											<td><img src="${pageContext.request.contextPath }/img/product/${ orderdetail.product.image }"
													 class="card-img-top"
													 height="50px"></td>
											<td class="pt-4">
											...
											<td class="pt-4">
												<fmt:formatNumber value="${ orderdetail.product.price  * orderdetail.quantity }"
																  type="currency"
																  currencySymbol="" /> <sup>đ</sup>
											</td>
										</tr>
