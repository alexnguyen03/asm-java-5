...
<html lang="en">
  <head>
    ...
    <style>
      body {
        background: url(${pageContext.request.contextPath}/img/login/6764552_3433839.jpg)
    ...
    <header class="container login__header__fixed">
      <nav class="navbar navbar-expand-sm container">
        <a class="navbar-brand text-dark font-weight-bold" href="/">
          <img src="/img/main-logo.png" height="33px" alt="" />
        </a>
        <button
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0 text-dark">
            <a href="/shop" class="btn btn-dark ml-3 font-weight-bold"
              >XEM TRƯỚC SẢN PHẨM</a
            >
          </ul>
        </div>
      </nav>
        ...
        <div class="card-body">
          ...
          <form action="/account/login" method="post" class="mt-5">
            ...
            <div class="form-group">
              ...
              />
              <small id="helpIdPassword" class="form-text text-muted"></small>
            </div>
