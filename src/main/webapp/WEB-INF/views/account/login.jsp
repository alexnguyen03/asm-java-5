		...
		<header class="container login__header__fixed">
			<nav class="navbar navbar-expand-sm container">
				<a class="navbar-brand text-dark font-weight-bold"
				   href="/"> <img src="/img/main-logo.png"
						 height="33px"
						 alt="" />
				</a>
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="navbar-nav ml-auto mt-2 mt-lg-0 text-dark">
						<a href="/shop"
						   class="btn btn-dark ml-3 font-weight-bold">XEM
							TRƯỚC SẢN PHẨM</a>
					</ul>
				</div>
			</nav>
					...
					<form action="/account/login"
						...
						<div class="form-check text-left mb-3">
							<input class="form-check-input"
								   ...
								   name="remember"
								   value="true"
								   id="defaultCheck1"> <label class="form-check-label font-weight-bold"
								   for="defaultCheck1">
						...
						<p class="text-left">
							Không thể đăng nhập? <a href="/account/forgotpassword"
							   ...
							   style="color: #0c2b4b">Lấy lại mật
								khẩu</a>
						</p>
