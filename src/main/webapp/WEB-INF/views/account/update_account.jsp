							...
							<div class="container mb-5 mt-5">
								<div class="row">
									<div class="col-lg-3 border-right">
										<label for="file-ip-1">
											<center>
												<img class="border border-2 bg-light p-1 border-success rounded-circle w-100"
													 style="height: 200px;"
										...
										<div class="input-group">
											<div class="custom-file">
												<input type="file"
													   ...
													   accept="image/*"
													   name="photo_file"
													   onchange="showPreview(event);"> <label class="custom-file-label"
													   for="file-ip-1">Chọn Ảnh</label>
											</div>
										</div>
									</div>
									<div class="col-lg-9">
