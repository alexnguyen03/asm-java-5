						...
						<div class="container mb-5 mt-5">
							<div class="row">
								<div class="col-lg-3 border-right">
									<img id="previewImage" src="${pageContext.request.contextPath }/img/user-management/${ account.photo }" style="height: 200px;"
									...
									<div class="input-group">
										<div class="custom-file">
											<input type="file" class="custom-file-input" id="image"
												name="photo_file" onchange="previewImage(event)"> <label
												class="custom-file-label" for="image">Chọn Ảnh</label>
										</div>
									</div>
								</div>
								<div class="col-lg-9">
									<div class="container">
										<div class="row">
											<div class="col-lg-6">
												<div class="form-group">
													<label for="username" class="form-label fw-bold">Tên
														...
														id="username" readonly value="${ account.username }" name="username">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group">
													<label for="password" class="form-label fw-bold">Mật
														...
														id="password" name="password"value="${ account.password }">
												</div>
											</div>
											<div class="col-lg-6 mt-3">
												<div class="form-group">
													<label for="fullname" class="form-label fw-bold">Họ
														...
														id="fullname" name="fullname"value="${ account.fullname }">
												</div>
											</div>
											<div class="col-lg-6 mt-3">
												<div class="form-group">
											...
											<input hidden type="text" name="photo" value="${ account.photo }">
										</div>
										<button type="submit"
