				...
				<form action="/account/change-password" method="POST" class="mt-5">
					...
					<div class="form-group">
						<input type="password" class="form-control" name="password"
							value="${sessionScope.password}" id="username"
							aria-describedby="helpId" placeholder="Mật khẩu" /> <small
							id="helpId" class="form-text text-muted"></small>
					</div>
					<div class="form-group">
						<input type="password" class="form-control" name="newpass"
							id="newpass" aria-describedby="helpId" placeholder="Mật khẩu mới" />
						<small id="helpId" class="form-text text-muted"></small>
					</div>
					<div class="form-group">
						<input type="password" class="form-control" name="confirm"
							id="confirm" aria-describedby="helpId"
							placeholder="Xác nhận mật khẩu" /> <small id="helpId"
							class="form-text text-muted"></small>
					</div>
					<p class="text-left">
						Quên mật khẩu? <a href="#" class="font-weight-bold"
