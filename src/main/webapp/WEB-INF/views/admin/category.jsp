	...
	<div class="app-container">
		...
		<div class="app-content">
			...
			<div class="modal fade" id="AddCategoryModel" tabindex="-1"
				role="dialog" aria-labelledby="AddCategoryModelLabel"
				aria-hidden="true">
					...
					<div class="modal-content">
						<div class="modal-body container-fluid">
							...
							<form:form action="/admin/category-manager/create"
								modelAttribute="item" cssClass="row">
								<div class="col-12">
									<div class="form-group">
										<%-- 										<form:input path="id" placeholder="Id" hidden="hidden" /> --%>
										<label for="id" class="font-weight-bold">Mã Danh mục</label>
			...
			<div class="products-area-wrapper tableView overflow-auto">
                ...
                <circle cx="12" cy="19" r="1" />
						...
						<!-- Update Product -->
						<div class="modal fade" id="UpdateCategoryModal${item.id}"
								...
								<div class="modal-content">
									<div class="modal-body container-fluid">
										...
										<form action="/admin/category-manager/edit"
											...
											<div class="col-12">
												<div class="form-group">
													<label for="name" class="font-weight-bold">Tên danh
														mục</label> <input name="name" value="${item.name}" type="text"
											...
											<div class="col-12 mt-5 d-flex justify-content-end">
												...
												<button class="btn btn-dark font-weight-bold"
													style="width: 250px;" type="submit">Cập nhật danh
													mục</button>
											</div>
										</form>
									</div>
						...
						<!-- Delete Product -->
						<div class="modal fade " id="DeleteCategoryModal${item.id}"
							tabindex="-1" role="dialog"
