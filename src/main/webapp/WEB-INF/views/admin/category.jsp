			...
			<div class="app-content-actions">
				...
				<div class="app-content-actions-wrapper">
					<div class="filter-button-wrapper d-flex justify-content-betwwen">
						<a href="/admin/category-manager/add" class="btn btn-dark">Thêm
							Danh mục</a>
					</div>
				</div>
			</div>
			...
			<div class="products-area-wrapper tableView overflow-auto">
				...
				<div class="products-header">
					...
					<div class="product-cell category">
						Tên danh mục<a
							href="/admin/category-manager?field=id&p=${p}&eop=${eop}&d=${!d}"
				...
				<!-- 	Loop	 -->
				<c:forEach var="category" items="${page.content}" varStatus="loop">
					<div
									...
									<nav aria-label="Page navigation example">
										<ul class="pagination pagination-sm mb-0 py-1 ml-3">
											<li class="page-item ${ p  == 0 ?'d-none'  : '' } "><a
												...
												href="/admin/category-manager?field=${field}&p=0&eop=${eop}&d=${d}">First</a></li>
