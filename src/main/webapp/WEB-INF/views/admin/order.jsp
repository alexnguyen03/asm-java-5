      ...
      <div class="app-content">
        ...
        <div class="app-content-actions">
            ...
            <div class="input-group input-group-sm">
              <div class="input-group-prepend">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="#">Tìm theo ngày</a>
                  <a class="dropdown-item" href="#">Tìm theo tháng</a>
                </div>
              </div>
              <input
                type="month"
          ...
          <div class="w-50 d-flex justify-content-center">
            <div
              class="product-cell status-cell d-flex flex-column justify-content-center"
            >
              <span class="status active py-2"
                >Hiển thị <strong class="mx-2">15 / 20</strong> người dùng</span
              >
            </div>
          ...
          <div class="app-content-actions-wrapper">
            <a
              href="/admin/order"
              class="btn btn${isCancel == true ? '-outline': ''}-primary btn-sm mx-2 ml-4"
              >Đơn đã đặt</a
            >
            <a
              href="/admin/order/cancel"
              class="btn btn${isCancel == true ? '': '-outline'}-warning btn-sm mx-2"
              >Đơn đã hủy</a
            >
        ...
        <div class="products-area-wrapper tableView">
          ...
          <div class="products-row">
            ...
            <div class="product-cell category">
              <span class="cell-label">Tổng tiền</span>350.000 <sup>đ</sup>
            </div>
            <div class="product-cell status-cell">
            ...
            <div class="product-cell sales">
              <span class="cell-label">Ngày đặt</span>26/05/2003
            </div>
            <div class="product-cell address">
              <span class="cell-label">Địa chỉ </span>Vĩnh Long
            </div>
                  ...
                  <tbody>
                    <tr class="">
                      ...
                      <td class="product__cart__item">
                        <img
                          src="${pageContext.request.contextPath}/img/shopping-cart/64 Audio A12t.jpg"
                          alt=""
                          width="35px"
                          height="35px"
                          class=""
              ...
              <div class="col-5">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="mb-2">
                      <span>Họ tên:</span>
                      <strong class="text-danger">Nguyễn Hoài Nam</strong>
                    </div>
                    <div class="mb-2">
                      <span>Địa chỉ</span>
                      <strong class="text-danger">Vĩnh Long</strong>
                    </div>
                    <div class="mb-2">
                      <span>Số điện thoại</span>
                      <strong class="text-danger">0326265147</strong>
                    </div>
                    <div class="mb-2">
                      <span>Ngày đặt hàng</span>
                      <strong class="text-danger">26/05/2023</strong>
                    </div>
                    <div class="mb-2">
                      <span>Email</span>
                      <strong class="text-danger"
                        >namnhpc03517@fpt.edu.vn</strong
                      >
                    </div>
                    <hr />
                    ...
                    <div class="mb-2">
                      <span>Tạm tính:</span>
                      <strong class="text-danger">400.00 <sup>đ</sup></strong>
                    </div>
                    <div class="mb-2">
                      <span>Giảm giá:</span>
                      <strong class="text-danger">0 <sup>đ</sup></strong>
                    </div>
                    <div class="mb-2">
                      <span>Thành tiền:</span>
                      <strong class="text-danger">400.000 <sup>đ</sup></strong>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row rounded">
                <div class="col-12">
                    ...
                    <div class="col-6">
                      <div class="input-group">
                        ...
                        >
                          ...
                          <option value="3" class="text-secondary">
                            Đang giao
                          </option>
                  ...
                  <div class="form-group col-lg-12 mx-auto mb-4">
                    ...
                    <a href="#" class="btn btn-danger float-right w-75">
