                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <h5 class="card-text font-weight-bold">
                        Tỉ lệ số lượng sản phẩm bán được tăng <span style="color: #dc3545">5%</span> <span>trong 1
                          tuần.</span>
                      </h5>
                    </div>
                  </div>
                ...
                <div class="col-lg-3 col-sm-6">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <span class="fond-weight-bold"
                            style="color: #dc3545"><i class='bx bx-trending-up'></i> 5% </span>với tháng trước
                    </div>
                  </div>
                </div>
                <!-- Item -->
                <div class="col-lg-3 col-sm-6">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <span class="fond-weight-bold"
                            style="color: #dc3545"><i class='bx bx-trending-up'></i> 71% </span> đích đến.
                    </div>
                  </div>
                </div>
                <!-- Item -->
                <div class="col-lg-3 col-sm-6">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <span class="fond-weight-bold"
                            style="color: #dc3545"><a class="btn btn-outline-dark"
                           href="/admin/order?status=C">Xem
                          ngay</a> </span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-6 d-flex flex-column">
                          <div>
                            <span style="color: #dc3545"><i class='bx bx-package mr-2'></i></span>Sản phẩm ra mắt
                          </div>
                          <h3 class="font-weight-bold">25</h3>
                          <div>
                            <span class="fond-weight-bold"
                                  style="color: #dc3545"><i class='bx bx-trending-up'></i> avg. 5% </span> sản phẩm được
                            thêm
                          </div>
                        </div>
                        <div class="col-6 d-flex flex-column">
                          <div>
                            <span style="color: #dc3545"><i class='bx bx-package mr-2'></i></span>Sản phẩm bán được
                          </div>
                          <h3 class="font-weight-bold">10</h3>
                          <div>
                            <span class="fond-weight-bold"
                                  style="color: #dc3545"><i class='bx bx-trending-up'></i> avg. 15% </span> tháng trước
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-8">
                  <div class="card h-100">
                    <div class="card-body">
                      ...
                      <img src="${pageContext.request.contextPath}/img/admin-analystic.jpg"
                           width="100%"
                           height="100%"
                           class="img-fluid"
                           alt="" />
