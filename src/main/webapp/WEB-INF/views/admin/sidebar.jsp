...
<div class="sidebar">
	<div class="sidebar-header">
		<div class="app-icon">
			<img src="/img/main-logo.png" alt="" class="img-fluid mr-auto" />
		</div>
	</div>
	<ul class="sidebar-list">
		<li class="sidebar-list-item ${isPageActive == 'index'?'active':''}">
			<a href="/admin"> <i class="fa fa-home mr-2" aria-hidden="true"></i>
				<span>Trang chủ</span>
		</a>
		</li>
		...
		<li class="sidebar-list-item ${isPageActive == 'product'?'active':''}">
			<a href="/admin/product-manager"> <i
				class="fa fa-product-hunt mr-2" aria-hidden="true"></i> <span>Sản
					phẩm</span>
		</a>
		</li>
		<li
			class="sidebar-list-item ${isPageActive == 'category'?'active':''}">
			<a href="/admin/category-manager"> <i
				class="fa-solid fa-bars mr-2"></i> <span>Danh mục</span>
		</a>
		</li>
		...
		<li
			class="sidebar-list-item ${isPageActive == 'statistic'?'active':''}">
