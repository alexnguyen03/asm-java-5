	...
	<div class="app-container">
		...
		<div class="app-content">
			...
			<div class="products-area-wrapper tableView overflow-auto">
				...
				<!-- Product rendering -->
				<c:forEach var="product" items="${page.content}" varStatus="loop">
					<div
						...
						<div class="product-cell image">
							<img
								...
								style="z-index: 1000;" data-toggle="modal"
								data-target="#prevImg${product.id}" alt="${product.name}" />
						</div>
						...
						<!-- Modal -->
						<div class="modal fade" id="prevImg${product.id}" tabindex="-1"
