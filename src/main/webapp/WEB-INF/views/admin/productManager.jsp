					...
					<div class="app-content-actions-wrapper">
						<div class="filter-button-wrapper d-flex justify-content-betwwen">
							<a href="/admin/product-manager"
							   class="btn btn-outline-dark mr-3">Rest
								Page</a>
							<button type="button"
									class="btn btn-dark"
									data-toggle="modal"
								...
								<div class="modal-dialog modal-xl"
									...
									<div class="modal-content">
										<div class="modal-body container-fluid">
											...
											<!-- Form -->
											<form action="/admin/product-manager/update"
												  class="row"
												  method="POST"
												  enctype="multipart/form-data">
												<!-- Left form -->
												<div class="col-4">
													...
													<div class="col-12">
														<div class="mb-3">
															<label for=""
																   class="font-weight-bold">Hình ảnh
																sản phẩm</label><label for="Video-edit-myPicture"
																   class="video-edit-preview"> <img
																	 ...
																	 alt="${product.name}" />
															</label> <input name="image"
																   value="${product.image}"
																   hidden="hidden" /> <input type="file"
																   name="photo_file"
																   hidden="hidden"
																   id="Video-edit-myPicture" /> <span
																  class="error"></span>
														</div>
													</div>
												</div>
												...
												<div class="col-8">
													<div class="row">
														...
														<div class="col-12">
															<div class="form-group">
																<label for="name"
																	   class="font-weight-bold">Tên
																	sản phẩm</label> <input name="name"
																	   type="text"
																	   class="form-control"
																	   id="name"
																	   value="${product.name}"
														...
														<div class="col-6">
															<div class="form-group">
																<label for="price"
																	...
																	sản phẩm</label> <input name="price"
																	   type="text"
																	   class="form-control"
																	   id="exampleInputEmail1"
																	   value="${product.price}"
														...
														<div class="col-6">
															<div class="form-group">
																<label for="category"
																	   class="font-weight-bold">Mã
																	danh mục</label> <select id="category"
																		name="category.id"
																		class="form-control"
																		required>
														...
														<div class="col-6">
															<div class="form-group">
																<label for="quantity"
																	   class="font-weight-bold">Số
																	lượng</label> <input name="quantity"
